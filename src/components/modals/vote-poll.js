      ...
      >
        ...
        >
          ...
          <TextInput
              ...
              editable={this.info && this.info.email === this.User.user.email ? true : false}
          ...
          >
              {this.state.poll ? this.state.poll.voted : 0} voted
          </Text>
          <Dash
              dashGap={5}
              dashLength={7}
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                user.push(this.User.user.email);
                  this.itemRefs.child("Group").child(this.Global.groupKey)
                      .child("postedPoll")
                      .child(this.state.poll.key)
                      .child("options").on("value", dataSnapshot => {
                      dataSnapshot.forEach(child =>{
